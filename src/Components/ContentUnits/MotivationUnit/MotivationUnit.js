...
import MotivationUnitActivities from './MotivationUnitActivities';

class MotivationUnit extends Component {

  state = {
    activitiesArr: MotivationUnitActivities[this.props.role],
    numActivitiesToDo: MotivationUnitActivities[this.props.role].length,
